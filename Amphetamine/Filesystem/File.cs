...
{
    internal class File
        : FileBase, IFileInfoFactory
    {
        private MemoryMappedFileSystem memoryMappedFileSystem;

        public File(MemoryMappedFileSystem memoryMappedFileSystem)
        {
            this.memoryMappedFileSystem = memoryMappedFileSystem;
        }
        ...
        FileInfoBase IFileInfoFactory.FromFileName(string fileName)
        {
            throw new NotImplementedException();
        }
    }
